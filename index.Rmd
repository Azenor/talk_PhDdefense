...
.center[**Allometric scaling of ecological processes**]
...
1. Thermal adaptation of growth rate in wild bacterial strains
...
1. Thermal adaptation of growth rate in wild bacterial strains
2. Theory on the temperature dependence of trophic control
...
1. Thermal adaptation of growth rate in wild bacterial strains
2. Theory on the temperature dependence of trophic control
3. Drivers of latitudinal gradient in trophic control in fish food webs
...
<br>
.center[Suggesting strong kinetics constraints on biological rates : assumption of a fixed relationship between temperature and biological rates across latitudes (macroecology).]
...
.center[![:scale 30%](images/complex_foodweb.svg)]

- Temperature dependence of biological rates
  - Same activation energy for every species
- Self-regulation
  - A key but still too mysterious parameter
  - Assumptions on coexistence and stability
  - Biomass scaling laws
...
Food webs are more top-down regulated toward the poles]
...
.center[**is mainly driven by species richness**

![:scale 40%](images/variables_latitude2_defense_lambda.svg)
...
- Species rich communities around the equator more bottom-up controlled
- Species at high latitudes more top-down controlled (control by predator, trophic cascades, cycles)
...
1. Support for limited thermal adaptation but strong kinetic constraints
2. Derive temperature dependance of trophic control
...
3. Latitudinal gradient in trophic control in fish food webs
   - Top-down control decreases with latitudes
   - Mostly driven by species richness

---
# Latitudinal variation in trophic control

.center[![:scale 50%](images/biotic_interaction_map.svg)]

- Stronger top-down control at high latitudes : predator-prey cycle
- Weaker top-down regulation (predation) in tropical species rich communities
  - Different ways of quantifying interaction strength (pairwise or total effect)
...
.center[**Interactive effects : global changes such as biodiversity loss**]
